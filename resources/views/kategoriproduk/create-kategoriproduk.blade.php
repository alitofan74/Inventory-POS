...
<div class="card card-primary">
    <div class="card-header">
        <h4><span class="text-secondary">Data Kategori Produk //</span> Buat Data Baru</h4>
    </div>
    <form action="{{route("kategoriproduk.savekategori")}}" method="post" enctype="multipart/form-data">
    @csrf
    @method("POST")
    <div class="card-body">
